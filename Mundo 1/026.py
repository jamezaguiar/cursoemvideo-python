...
print("A primeira letra A apareceu na posição {}".format(int(frase.upper().find("A"))+1))
print("A última letra A apareceu na posição {}".format(int(frase.upper().rfind("A")+1)))